...
class MapUtils {
  static getMarkerPic() async {
    ...
    //         'images/images/deliveryman.png')
    //     .then((value) => markerss.add(value));
    markerss.add(
        await createBitmapDescriptorFromImage('images/deliveryman.png', ''));
    markerss.add(await createBitmapDescriptorFromImage('images/mobil.png', ''));
    markerss.add(await createBitmapDescriptorFromImage('images/1.png', ''));
    markerss.add(await createBitmapDescriptorFromImage('images/2.png', ''));
    markerss
        .add(await createBitmapDescriptorFromImage('images/map_pin.png', ''));
    markerss
        .add(await createBitmapDescriptorFromImage('images/porter.png', ''));
