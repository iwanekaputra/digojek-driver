...
class OnWayProductToDestination extends StatelessWidget {
  ...
  const OnWayProductToDestination({super.key, this.documentSnapshot});
...
class OnWayProductToDestinationBody extends StatefulWidget {
  final DocumentSnapshot? documentSnapshot;
  const OnWayProductToDestinationBody({super.key, this.documentSnapshot});
...
class OnWayProductToDestinationBodyState
                                                                  ...
                                                                  child: Column(
                                                                    children: <Widget>[
                                                                          ...
                                                                          children: <Widget>[
                                                                            ...
                                                                            Expanded(
                                                                              child: ListTile(
                                                                                title: Text(
                                                                                  data['type_order'],
                                                                                  style: Theme.of(context).textTheme.bodySmall!.copyWith(letterSpacing: 0.07, fontWeight: FontWeight.bold),
                                                                                ),
                                                                                subtitle: Row(
                                                                                  children: <Widget>[
                                                                                    Text(
                                                                            ...
                                                                            Text(
                                                                              formatCurrency(doc['price_trip']),
                                                                              style: Theme.of(context).textTheme.bodySmall!.copyWith(color: kMainColor, fontWeight: FontWeight.bold, fontSize: 11.7, letterSpacing: 0.06),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: <Widget>[
                                                                            ...
                                                                            IconButton(
                                                                              ...
                                                                              onPressed: () async {
                                                                                await FlutterPhoneDirectCaller.callNumber(data['nohp_customer']);
                                                                              },
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ...
                                                                      Column(
                                                                        children:
                                                                          ...
                                                                          return Row(
                                                                            children: <Widget>[
                                                                              Padding(
                                                                                  padding: const EdgeInsets.only(left: 28.0, bottom: 6.0, top: 6.0, right: 10.0),
                                                                                  child: Icon(
                                                                                    Icons.location_on,
                                                                                    size: 14.0,
                                                                                    color: kMainColor,
                                                                      ...
                                                                      Row(
                                                                        children: <Widget>[
                                                                          Padding(
                                                                              padding: const EdgeInsets.only(left: 28.0, bottom: 12.0, top: 12.0, right: 10.0),
                                                                              child: Icon(
                                                                                Icons.navigation,
                                                                                size: 14.0,
                                                                                color: kMainColor,
                                                                      ...
                                                                      BottomBar(
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            await addTransactionMerchant(merchants,
                                                                                products);
  ...
  Future<void> addTransaction() async {
    if (widget.documentSnapshot!['payment_method'] == 'cash' ||
        widget.documentSnapshot!['payment_method'] == 'Tunai') {
      double price_driver = widget.documentSnapshot!['price_trip'] * 11 / 100;
      num? saldo = driver!.balance! -
          (widget.documentSnapshot!['price_trip'] * 11 / 100);
      final res = await SharedServices().addTransaction(
          driver!.id.toString(),
          price_driver.toString(),
          'keluar',
          'produk',
          widget.documentSnapshot!['payment_method']);
    } else if (widget.documentSnapshot!['payment_method'] == 'saldo') {
      final res = await SharedServices().addTransaction(
          driver!.id.toString(),
          widget.documentSnapshot!['price_trip'].toString(),
          'masuk',
          'produk',
          widget.documentSnapshot!['payment_method']);
    }
  ...
  Future<void> addTransactionMerchant(
      List<QueryDocumentSnapshot<Map<String, dynamic>>> merchants,
      List<QueryDocumentSnapshot<Map<String, dynamic>>> products) async {
    for (var i = 0; i < merchants.length; i++) {
      num totalPriceProduct = 0;
      for (var h = 0; h < products.length; h++) {
        if (products[h]['merchant_id'] == merchants[i]['merchant_id']) {
          totalPriceProduct += products[h]['total_price'];
        }
      }

      if (widget.documentSnapshot!['payment_method'] == 'cash' ||
          widget.documentSnapshot!['payment_method'] == 'Tunai') {
        double price_merchant = totalPriceProduct * 11 / 100;
        final res = await SharedServices().addTransactionMerchant(
            merchants[i]['merchant_id'].toString(),
            price_merchant.toString(),
            'keluar',
            'produk',
            widget.documentSnapshot!['payment_method']);
        Map<String, dynamic> merchant = await SharedServices()
            .showMerchant(merchants[i]['merchant_id'].toString());
        num? saldo = merchant['balance'] - (totalPriceProduct * 11 / 100);
        final updateSaldoMerchant = await SharedServices().updateSaldoMerchant(
            merchants[i]['merchant_id'].toString(), saldo?.toString());
      } else if (widget.documentSnapshot!['payment_method'] == 'saldo') {
        final res = await SharedServices().addTransactionMerchant(
            merchants[i]['merchant_id'].toString(),
